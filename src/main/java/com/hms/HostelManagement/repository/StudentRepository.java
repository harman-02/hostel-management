...
public class StudentRepository {
    ...
    public void createStudent(Student student) {
        String sql = "INSERT INTO student (username,password,role,rollNo, name, phone, dob, address, email) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        template.update(
                sql, student.getUsername(), student.getPassword(), student.getRole(), student.getRollNo(),
                student.getName(), student.getPhone(), student.getDob(), student.getAddress(),student.getEmail());
    }
