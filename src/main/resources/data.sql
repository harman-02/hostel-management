...
insert into studentusermapping(username, rollNo, hostelRegistrationId) values('user1', 2, 2);
insert into student(name, email, phone, branch, balance, Dob) values('harman','harman@gmail.com', 90239, 'CSE', '15000', 20/02/2002);

insert into student(name, email, phone, branch, balance, Dob) values('hardik','hardik@gmail.com', 902398, 'CSE', '15000', 2003);
select * from student;
insert into session(start_date) values ('2016-02-02');
Insert into User(username, password, role) values('admin1','1234', 'admin');
Insert into User(username, password, role) values('user1','1234', 'student');
insert into hostel_registration(hostel_id, session) values (1,1);
insert into hostel_registration(hostel_id, session) values (2,1);
